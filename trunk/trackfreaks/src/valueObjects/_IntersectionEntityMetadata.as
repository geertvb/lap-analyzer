...
[ExcludeClass]
internal class _IntersectionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var entityName:String = "Intersection";
    model_internal static var dependentsOnMap:Object;    
    model_internal static var dependedOnServices:Array =  new Array();
    
    
    model_internal var _instance:_Super_Intersection;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();
    
    public function _IntersectionEntityMetadata(intersection : _Super_Intersection)
    {
        ...
        model_internal::_instance = intersection;     
    }
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Intersection");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
       if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Intersection");  
     ...
     override public function getValue(propertyName:String):*    
     {
         ...
         {
         	throw new Error(propertyName + " does not exist for entity Intersection");
         }     
    ...
    public function get isValid() : Boolean
    {
     ...
     [Bindable(event="propertyChange")] 
     public function get isAngleAvailable():Boolean
     {
        return true;
     }                       
    ...
    [Bindable(event="propertyChange")]   
    public function get angleStyle():com.adobe.fiber.styles.Style
    {
		return model_internal::_nullStyle;		
    }      
