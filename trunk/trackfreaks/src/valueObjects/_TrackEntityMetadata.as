...
internal class _TrackEntityMetadata extends AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("name", "lng", "lat", "url", "track_id");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("name", "lng", "lat", "url", "track_id");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("name", "lng", "lat", "url", "track_id");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("name", "lng", "lat", "url", "track_id");
