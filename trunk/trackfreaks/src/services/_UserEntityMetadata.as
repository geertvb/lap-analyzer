...
internal class _UserEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("user_id", "username", "password", "role");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("user_id", "username", "password", "role");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("user_id", "username", "password", "role");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("user_id", "username", "password", "role");
